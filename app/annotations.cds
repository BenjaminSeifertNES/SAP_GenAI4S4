using { bTPGenAI4S4_BenjaminSeifert3Srv } from '../srv/service.cds';

annotate bTPGenAI4S4_BenjaminSeifert3Srv.CustomerMessage with @UI.HeaderInfo: { TypeName: 'Customer Message', TypeNamePlural: 'Customer Messages', Title: { Value: customerMessageID } };
annotate bTPGenAI4S4_BenjaminSeifert3Srv.CustomerMessage with {
  ID @UI.Hidden @Common.Text: { $value: customerMessageID, ![@UI.TextArrangement]: #TextOnly }
};
annotate bTPGenAI4S4_BenjaminSeifert3Srv.CustomerMessage with @UI.Identification: [{ Value: customerMessageID }];
annotate bTPGenAI4S4_BenjaminSeifert3Srv.CustomerMessage with {
...
annotate bTPGenAI4S4_BenjaminSeifert3Srv.CustomerMessage with @UI.LineItem: [
...
annotate bTPGenAI4S4_BenjaminSeifert3Srv.CustomerMessage with @UI.FieldGroup #Main: {
...
annotate bTPGenAI4S4_BenjaminSeifert3Srv.CustomerMessage with @UI.Facets: [
  { $Type: 'UI.ReferenceFacet', ID: 'Main', Label: 'General Information', Target: '@UI.FieldGroup#Main' }
];

annotate bTPGenAI4S4_BenjaminSeifert3Srv.CustomerMessage with @UI.SelectionFields: [
  customerMessageID
];
