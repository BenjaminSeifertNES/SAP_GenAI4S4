 ...
 * @Before(event = { "READ" }, entity = "bTPGenAI4S4_BenjaminSeifert3Srv.CustomerMessage")
...
module.exports = async function (request) {
	...
	try {
		...
		customerMessages = await SELECT.from('BTPGenAI4S4_BenjaminSeifert3.CustomerMessage').forUpdate();
	} catch (error) {
